...
API_URL_REDIRECT = {"https://api.openai.com/v1/chat/completions": "https://api.jingyan.live/v1/chat/completions"}
...
AVAIL_LLM_MODELS = ["gpt-3.5-turbo", "gpt-3.5-turbo-0613", "gpt-3.5-turbo-16k", "gpt-3.5-turbo-16k-0613", "gpt-4", "chatglm", "moss", "newbing", "stack-claude"]
