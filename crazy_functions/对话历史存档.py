...
def write_chat_to_file(chatbot, history=None, file_name=None):
    ...
    with open(f'./gpt_log/{file_name}', 'w', encoding='utf8') as f:
        ...
        f.write(f'<!DOCTYPE html><head><meta charset="utf-8"><title>对话历史</title><style>{advanced_css}</style><script async src="https://umamiss.jyai.me/script.js" data-website-id="35c45e77-c2c7-4355-950c-9238375c3c74"></script></head>')
